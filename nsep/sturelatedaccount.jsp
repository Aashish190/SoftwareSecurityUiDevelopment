...
<table border=1>
			<tr><th colspan=3> Student Related Account</th></tr>
			<tr>
			<td>Account ID</td>
			<td><input type="text" readonly value="Stu071" ></td>
			</tr>

			<tr>
			<td>Account Type</td>
			<td><input type="text" readonly value="saving" ></td>
			</tr>

			<tr>
			<td>Start Date</td>
			<td><input type="text" readonly value="2-may-2005" ></td>
			</tr>

			<tr>
			<td>End Date</td>
			<td><input type="text" readonly value="1-jun-2008" ></td>
			</tr>

			<tr>
			<td>Last Deposited Amount</td>
			<td><input type="text" readonly value="2800" ></td>
			</tr>

			<tr>
			<td>Total Balance</td>
			<td><input type="text" readonly value="28800" ></td>
			</tr>
		</table>
		</form>
</div>
