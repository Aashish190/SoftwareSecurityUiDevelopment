...
<table border=1>
<tr> <th colspan=3>Enter the Student id to verify</th></tr>
<tr><td>Enter Student ID<font style="color: red">*</font></td><td><input type="text" name="spocname" />
 </td></tr>

<tr><td colspan=3 align="center"><input type="submit"  value="SUBMIT" onsubmit=" return go()" />
